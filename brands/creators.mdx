...
- **Interaction Rate**\
  Engagement Rate represents the percentage of the audience that interacts with the content. It’s calculated as **Interactions divided by Reach**, offering a normalized metric that compares creators of different sizes on an even playing field.
- **Views**\
...
## Video walkthrough of Creators

A full video walkthrough of the Creators section is to come. Stay tuned\!