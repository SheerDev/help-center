...
description: "The following segment is an deep dive into the Content Library of Sheer. The Content Library is your centralized hub for managing all the influencer-generated content from your campaigns. It’s designed to keep your assets organized, searchable, and ready to review, reuse, or repurpose. Whether you're overseeing hundreds of posts or just a few key pieces, the Content Library ensures nothing gets lost in the shuffle."
---
...
<Frame>
  ![Content Preview](images/contentpreview.png)
</Frame>
...
<Frame>
  ![Content comments](images/commentsexample.png)
</Frame>
...
<Frame>
  ![Creating usage rights](images/contentrightsone.png)
</Frame>
...
This allows you to name, organize and filter content before sharing with others internally or externally\!

<Frame>
  ![Content Inbox Example](images/Contentinboxexample.png)
</Frame>

## Video walkthrough of Content Library

A full video walkthrough of the content library is to come. Stay tuned\!