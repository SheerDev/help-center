...
**following is an example of a how a search look in sheer**

<Frame>
  ![contentlibraryexample](/images/searchexample.png)
</Frame>
...
You are also able to apply a keyword to your Search. Sheer will only show influencers if there is a match to the keyword in the influencers bio or caption of their posts.

Keywords are applied as a whole. Therefore, you may use a phrase consisting of mulptiple words with space between the such as "get ready with me", or simply use singular words like "grwm" or "vlog". Use the keyword best suited for the results you are looking for.

If you are interested in looking at the mediakit of a specific influencer, use the @ sign with the influencers username. This will cause sheer to look for the specific profile.

<Frame>
  ![contentlibraryexample](/images/searchkeywords.png)
</Frame>
...
<Frame>
  <img
    src="/images/searchaudience.png"
    alt="contentlibraryexample"
    style={{ width:"100%" }}
  />
</Frame>
...
<Frame>
  ![contentlibraryexample](/images/searchinfluencer.png)
</Frame>
...
<Frame>
  ![contentlibraryexample](/images/searchshortlist.png)
</Frame>
...
## Video walkthrough of Public Search

A full video walkthrough of the Public Search is to come. Here we will do a deep dive with what each filter accomplishes. Furthermore, we will provide some video examples specific types of searches using Sheer. Stay tuned\!

### Video example 1 - Stay tuned\!

In the following video, we use Public Search to find family profiles on instagram.

### Video example 2 - Stay tuned\!

In the following video, we use Public Search to find fitness profiles on TikTok.

### Video example 3 - Stay tuned\!

In the following video, we showcase how you can use shortlists with Sheer Search.