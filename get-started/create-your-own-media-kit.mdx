...
You can create both an Instagram and TikTok media kit which includes both performance metrics and follower insights.
...
<Steps>
  ...
  <Step title="Step Four 🔜">
    Congratulations, you have now created a professional Media kit with Sheer and can now share it freely with brands or use it for your portfolio 🎉🎉
...
Below is an example of a Sheer media kit and language guide on the Average Post Performance metric:
